      ...
      settings = [
        {
          ...
          "backlight" = {
            ...
            format-icons = [
              "<span style='font-size:24px' color='#696969'> 󰃞 </span>"
              "<span style='font-size:24px' color='#A9A9A9'> 󰃝 </span>"
              "<span style='font-size:24px' color='#FFFF66'> 󰃟 </span>"
              "<span style='font-size:24px' color='#FFD700'> 󰃠 </span>"
            ];
          };
          "bluetooth" = {
