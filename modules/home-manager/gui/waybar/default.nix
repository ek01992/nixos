      ...
      settings = [
        {
          ...
          "backlight" = {
            ...
            format-icons = [
              "<span color='#696969' font_size='24px'> 󰃞 </span>"
              "<span color='#A9A9A9' font_size='24px'> 󰃝 </span>"
              "<span color='#FFFF66' font_size='24px'> 󰃟 </span>"
              "<span color='#FFD700' font_size='24px'> 󰃠 </span>"
            ];
          };
          "bluetooth" = {
